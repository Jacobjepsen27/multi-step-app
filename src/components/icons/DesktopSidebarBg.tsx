...
const DesktopSidebarBg = (props: ComponentPropsWithoutRef<"svg">) => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="274" height="568" fill="none" viewBox="0 0 274 568" {...props}>
...
export default DesktopSidebarBg;