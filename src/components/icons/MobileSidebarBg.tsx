...
const MobileSidebarBg = (props: ComponentPropsWithoutRef<"svg">) => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="375" height="172" viewBox="0 0 375 172" {...props}>
        <defs>
